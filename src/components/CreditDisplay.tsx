            ...
            >
              ...
              <div className="min-w-0 flex-1 text-left">
                <p className="font-orbitron text-[10px] tracking-wide text-pink-200">
                  Pay with $XRGE on {XRGE_CHAIN_NAME} — Loyalty Rewards
                </p>
                <p className="font-mono-share text-[9px] text-muted-foreground/90 leading-snug">
                  Bonus credits on every pack · spend more XRGE, unlock higher tiers up to +50%.{" "}
                  <span className="text-pink-300 underline underline-offset-2">Get XRGE on DexScreener →</span>
                </p>
              </div>
            </a>
          </DialogHeader>
