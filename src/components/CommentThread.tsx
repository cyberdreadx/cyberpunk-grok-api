      ...
      <div className="flex items-center gap-2 pt-1">
        <div className="flex-1 relative">
          ...
          <Input
            ...
            maxLength={1000}
            className="h-7 text-xs font-mono-share bg-input/50 border-border/30"
            onKeyDown={(e) => e.key === "Enter" && !e.shiftKey && handleSubmit()}
          />
        </div>
        <Button size="sm" variant="ghost" onClick={handleSubmit} disabled={submitting || !newText.trim()} className="h-7 w-7 p-0">
