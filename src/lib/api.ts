...
export const CREDIT_COSTS = {
  /** 4 credits per image generated (Grok standard) */
  imageGen: 4,
  /** 6 credits per image edited (Grok standard) */
  imageEdit: 6,
  /** 10 credits per image generated (Grok Pro) */
  imageGenPro: 10,
  /** 12 credits per image edited (Grok Pro) */
  imageEditPro: 12,
  ...
  imageGenPro2k: 20,
  imageEditPro2k: 24,
  /** 6 credits per second of video (Grok) */
  videoPerSecond: 6,
