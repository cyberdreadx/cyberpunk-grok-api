...
== GETTING CREDITS ==
- Subscriptions = monthly BONUS CREDITS (best value, beat every pack): Basic $9→150/mo, Premium $19→325, Pro $39→675, Elite $79→1400. GLTCH PRO and NSFW LoRAs are NOT part of any subscription — they are a separate one-time LoRA unlock. (Daily credits, missions and the spin wheel are admin-toggleable — see LIVE PLATFORM STATE for whether they're on right now; never promise them from memory.)
